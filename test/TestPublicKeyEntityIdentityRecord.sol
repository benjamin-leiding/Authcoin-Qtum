...
contract TestPublicKeyEntityIdentityRecord {
    ...
    function testCreateNewPublicKeyEntityIdentityRecord() public {
        ...
        PublicKeyEntityIdentityRecord r = new PublicKeyEntityIdentityRecord(1, block.timestamp, "rsa-pub-key", data, false, identifiers, hash, signature, DeployedAddresses.AuthCoin());
        ...
        //TODO hash & signature
        Assert.equal(bytes32(r.getContentType()), bytes32("rsa-pub-key"), "EIR type should be 'rsa-pub-key'");
