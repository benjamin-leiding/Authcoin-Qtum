...
contract TestRevokeEntityIdentityRecord {
    ...
    function testRevokeEntityIdentityRecordByRSAPublicKey() public {
        ...
        ac.registerEir("dummy", 1, block.timestamp, publicKey, false, new bytes32[](0), bytes32(0x1), new  bytes(128));
        ac.revokeEir(publicKey, directKeyRevocationSignature, "rsaPublicKey");
    ...
    function testRevokeEntityIdentityRecordByECPublicKey() public {
        ...
        ac.registerEir("dummy", 2, block.timestamp, publicKey, false, new bytes32[](0), bytes32(0x1), new  bytes(128));
        ac.revokeEir(publicKey, directKeyRevocationSignature, "ecPublicKeyAddress");
