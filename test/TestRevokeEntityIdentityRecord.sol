...
contract TestRevokeEntityIdentityRecord {
    ...
    function testRevokeEntityIdentityRecordByRSAPublicKey() {
        ...
        ac.registerEir("dummy", 1, block.timestamp, "rsaPublicKey", publicKey, false, new bytes32[](0), bytes32(0x1), new  bytes(128));
        ac.revokeEir(publicKey, directKeyRevocationSignature);
    ...
    function testRevokeEntityIdentityRecordByECPublicKey() {
        ...
        ac.registerEir("dummy", 2, block.timestamp, "ecPublicKeyAddress", publicKey, false, new bytes32[](0), bytes32(0x1), new  bytes(128));
        ac.revokeEir(publicKey, directKeyRevocationSignature);
